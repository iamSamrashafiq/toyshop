...
//Product Page
const appbarTitle =TextStyle(fontSize: 17,color: Colors.white,fontWeight: FontWeight.w700);
const productTitle = TextStyle(fontSize:14,color: Colors.white,fontWeight: FontWeight.w600);
