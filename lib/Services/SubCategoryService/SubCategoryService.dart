...
class SubCategoryService {
  Future<ApiResponse<SubCategoryResponseModel>> getSubCategory(
    ...
    try {
      ...
      var response = await Api.getRequestData(ApiEndPoints.Subcategories+id, context);

      print(response.toString());

      SubCategoryResponseModel responseModel = SubCategoryResponseModel.fromJsonList(response);


      productProvider.setSubCategoryResponseModel = responseModel;
